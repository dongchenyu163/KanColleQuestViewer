...
function againOver()
{
	...
	TweenLite.to(againPlate, 0.4, {y:h - 22, alpha:1, ease:Elastic.easeOut, onUpdate:drawAgainPate});
}
...
function againOut()
{
	...
	//
	TweenLite.killTweensOf(againPlate);
	TweenLite.to(againPlate, 0.2, {y:h - 19, alpha:0.8, ease: Power2.easeOut, onUpdate:drawAgainPate});
}
...
function drawAgainPate()
{
	...
	var plateGrad = ctx.createLinearGradient(-180,0,180,0);
