...
function drawBullet(bullObj)
{
	...
	if(Math.abs(dX) < 3 && Math.abs(dY) < 3)
	{
		...
		{
			if(bullObj.fx < 100 && bullObj.fy < horizLine + img_island.y - 1)
			{
				//
			}
			else
...
function checkFinBullet()
{
	if(bullArray.length === 1)
	{
		...
		if(shipLifes <= 0)
		{
			...
			plTxtNum = 2;
			//
									  addExp(  img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3);
			TweenMax.delayedCall(0.1, addExp, [img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3]);
			TweenMax.delayedCall(0.3, addExp, [img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3]);
			TweenMax.delayedCall(0.5, addExp, [img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3]);
			TweenMax.delayedCall(0.6, addExp, [img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3]);
			TweenMax.delayedCall(0.9, addExp, [img_ship.x - Math.random() * img_ship.pic.width / 3 - img_ship.pic.width / 3 - 140, -10 + Math.random() * 5, 0.5 + Math.random() * 0.3]);
			//
			goResult();
		}
	}
